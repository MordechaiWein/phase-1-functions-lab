...
function distanceFromHqInBlocks(start){
  if (start > 42) {return start - 42 }
  else if (start < 42) {return 42 - start }
}

function distanceFromHqInFeet(start){
    if (start > 42){return (start - 42) * 264}
    else if (start < 42) {return (42 - start) * 264 }
}
...
function calculatesFarePrice(start, destination){
  ...
  else if (feet >= 400 && feet < 2000) {return (feet - 400) * .02 }
